...
# SCPN Stellarator Core — portable diagnostic-plan envelope tests
...
from scpn_stellarator_core.plan_envelope import (
    ENVELOPE_SCHEMA,
...
FIXTURE_SHA256 = "88b1019ce4e004713d6da16032be96f1a49b00d73e613729be3cbe7eeae28060"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-STELLARATOR-CORE"
    assert NON_CLAIMS == (
