...
# SCPN Stellarator Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-STELLARATOR-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_stellarator_core.observability.CATALOGUE_BINDING`.
    plan_identifier
